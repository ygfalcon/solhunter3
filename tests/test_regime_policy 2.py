...
def test_swarm_coordinator_regime_weights():
    ...
    mem.log_trade(token="tok", direction="sell", amount=1, price=1.5, reason="a2")
    ...
    w_bull = coord.compute_weights(agents, regime="bull")
    w_bear = coord.compute_weights(agents, regime="bear")
