...
10. **Priority RPC endpoints**
    ...
    ```bash
export PRIORITY_RPC=https://mainnet.helius-rpc.com/?api-key=demo-helius-key,https://rpc.helius.dev/?api-key=demo-helius-key
    ```
...
[[nodes]]
solana_rpc_url = "https://rpc.helius.dev/?api-key=demo-helius-key"
