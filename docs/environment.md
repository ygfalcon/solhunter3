...
| `DISCOVERY_STATIC_FALLBACK_MIN_SEEDS` | `12` | Minimum number of seed tokens returned when every discovery source fails |
| `DISCOVERY_STATIC_FALLBACK_TOKENS` | `SOL, USDC, USDT, BONK, JUP, stSOL, ...` | Comma or newline separated list of static discovery fallback mints |
