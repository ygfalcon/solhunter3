...
STREAM_SCHEMAS: Mapping[str, Dict[str, Any]] = {
    ...
    STREAMS.market_ohlcv: {
        ...
        "properties": {
            ...
            "zvol": _number(),
            "asof_close": _number(),
            "schema_version": {"const": OHLCV_BAR_SCHEMA_VERSION},
    ...
    STREAMS.preliminary_snapshot: {
        ...
        "properties": {
            ...
            "asof": _number(),
            "px_mid_usd": _number(),
            "price_source": {"type": "string", "enum": ["jup_price", "pyth_mid"]},
            "staleness_ms": _number(),
            "price_confidence": {"type": ["number", "null"]},
            "liquidity_usd": _number(),
            "volume_1h_usd": _number(),
            "volume_24h_usd": _number(),
            "pair_age_min": {"type": ["number", "null"]},
            "score": _number(),
            ...
            "provenance": {
                ...
                "properties": {
                    ...
                    "producer": {
                        ...
                        "required": ["service", "build"],
                        "additionalProperties": True,
                    },
                },
                "required": ["sources", "producer"],
                "additionalProperties": True,
            },
            "schema_version": {"const": PRELIMINARY_SNAPSHOT_SCHEMA_VERSION},
        },
        "required": [
            "mint",
            "symbol",
    ...
    STREAMS.golden_snapshot: {
        ...
        "properties": {
            ...
            "px": {
                ...
                "required": ["mid_usd", "spread_bps", "bid_usd", "ask_usd", "ts"],
                "additionalProperties": True,
            },
            "liq": {
                "type": "object",
                "properties": {
                    "depth_pct": {"type": "object"},
                    "depth_usd_by_pct": {"type": "object"},
                    "bands": {"type": "array", "items": {"type": "object"}},
                    "asof": _number(),
                    "staleness_ms": _number(),
                },
                "required": ["depth_usd_by_pct", "bands", "asof"],
                "additionalProperties": True,
            },
            "ohlcv5m": {"type": "object"},
